...
<head>
    ...
    http://localhost:3306/enterprise_employee_management_system
    --%>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@sit.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">email</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_Update_input" placeholder="email@sit.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function build_emps_table(result){
            ...
            $.each(emps,function (index,item){
                ...
                btnTd = btnTd.append(editBtn).append(delBtn)
        ...
        function build_page_nav(result){
            ...
            //构建元素
            var fitstPageLi = $("<li></li>").append($("<a></a>").append("首页").attr("href","#"));
            var prePageLi = $("<li></li>").append($("<a></a>").append("&laquo;"));
            if (result.extend.pageInfo.hasPreviousPage == false){
                fitstPageLi.addClass("disabled");
                prePageLi.addClass("disabled");
            }else{
                //为元素添加点击翻页的事件
                fitstPageLi.click(function (){
            ...
            //添加首页和前一页的提示
            ul.append(fitstPageLi).append(prePageLi);
        ...
        //点击编辑按钮弹出模态框
        //我们是页面加载完成之后发送ajax请求创建的编辑按钮，所以不能用click直接给它绑定单击事件，因为click是在页面加载时完成绑定
        ...
        //check_item
        //当当前页的所有员工都被勾选上时，自动勾选上全选按钮
        $(document).on("click",".check_item",function (){
           //判断当前选择中的元素是否和页面总元素相等
